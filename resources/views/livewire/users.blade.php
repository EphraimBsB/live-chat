<div class="max-w-6xl mx-auto my-16">
    ...
    <h5 class="text-center text-5xl font-bold py3">Users</h5>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 p-2">
        ...
        <div class="w-full bg-white border border-gray-200 rounded-lg p-5 shadow">
            ...
            <div class="flex flex-col items-center pb-10">
                ...
                <img src="https://source.unsplash.com/500x500?face={{$key}}" alt="" class="w-24 h-24 mb-2.5 rounded-full shadow-lg">
