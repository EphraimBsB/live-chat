...
class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex gap-3 items-center overflow-x-scroll overflow-hidden p-2 bg-white">
            ...
            <button @click="type='all" :class="{'bg-blue-100 border-r-0 text-black': type=='all'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                All
            </button>

            <button @click="type='deleted" :class="{'bg-blue-100 border-r-0 text-black': type=='deleted'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                Deleted
            </button>
        </div>
        ...
        <ul class="p-2 grid w-full space-y-2">
            @if ($conversations)
                @foreach ($conversations as $key=> $conversation)
                    ...
                    <li class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-100 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id==$selectedConversation->id ? 'bg-gray-100/70':''}}">
                            ...
                            <a href="{{route('chat', $conversation->id)}}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                                ...
                                <div class="flex gap-x-2 items-center">
                                    ...
                                    <p class="grow truncate text-sm font-[100]">
                                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Deserunt quisquam itaque aliquid cum. Neque similique, reiciendis assumenda voluptatibus vitae quam quos modi itaque. Voluptatibus adipisci iusto perferendis tenetur, quam sit!
                                    </p>
