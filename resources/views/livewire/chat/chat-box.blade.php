<div class="w-full overflow-hidden">
    ...
    {{-- hearder --}}
    <header class="w-full sticky inset-x-0 flex pb-[5px] pt-[5px] z-10 bg-while border-b">
    ...
    <main class="flex flex-col gap-3 p-2.5 overflow-y-auto flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class(['max-w-[85%] md:max-w-[78%] flex w-auto gap-2 relative mt-2',])>
            ...
            {{-- message body --}}
            <div @class(['flex flex-wrap text-[150px] rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]',
                'rounded-bl-none border border-gray-200/40'=>false, 
                'rounded-br-none bg-blue-500/80 text-white'=>true,
            ])>

                <p class="whitespace-normal truncate text-sm md:text-base tracking-wide lg:tracking-normal">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit sapiente voluptatum atque fuga architecto dolores! Accusantium maxime eum ea, dolores vitae alias asperiores doloribus. Quibusdam architecto dolorem nisi ratione aspernatur.
                </p>
                ...
                <div class="ml-auto flex gap-2">
                    ...
                    {{-- message status, only shows if message belongs to auth --}}
                    <div>
                        {{-- double ticks --}}
